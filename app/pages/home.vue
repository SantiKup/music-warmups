...
const isStudent = computed(() => userEmail.value.endsWith("@students.nido.cl"));

// Check if user is an authorized teacher
const isTeacher = computed(() => isAuthorizedTeacher(userEmail.value));
